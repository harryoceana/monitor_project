...
int main(int argc, const char *argv[])
{
   ...
   piintf("<p><a href=\"/led.html\"><button>get back</button></a</p>");   //cgi 返回的3种方式，不止3种
   printf("\n<a href=\"/led.html\">get back</a>\n");
   printf("<center><input type=\"button\" value=\"get back\"\
		   onclick=\"window.location.href='http://192.168.1.107/led.html'\"></center>\n\n");
   printf("</body>\n");
	...
	close(led_fd);
    printf("</html>\n");
//  printf("<a href=\"/led.html\">get back</a>\n");
